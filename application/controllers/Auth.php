...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		else
		{
			...
			if ($this->ion_auth->get_users_groups()->row()->id == 3) {
				$userDetails = $this->ion_auth->user()->result();
				array_shift($userDetails);
				$this->data['user'] = $this->ion_auth->user()->result();
				$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'patient');
	...
	public function create_schedule()
	{
		...
		else
		{
			...
			$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'header');
			$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'create_schedule', $this->data);
			$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'footer');
		}
	}
